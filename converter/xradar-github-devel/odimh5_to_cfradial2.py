...
# dependencies = ["xradar @ git+https://github.com/openradar/xradar@main"]
# ///
...
xradar source:
    ...
    xradar from the "main" branch of https://github.com/openradar/xradar
    (the official development branch) instead of from PyPI, to try out
    unreleased functionality ahead of the next official release.
